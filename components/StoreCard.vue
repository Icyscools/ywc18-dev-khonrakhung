        ...
        <div class="flex justify-start">
          <div v-for="(facility, index) in store.facilities" :key="index">
            <div class="faculity-item">
              <img v-if="facility == 'ที่จอดรถ'" src="/icons/ที่จอดรถ.png" :title="facility" />
              <img v-else-if="facility == 'บริการจัดส่งอาหาร'" src="/icons/บริการจัดส่งอาหาร.png" :title="facility" />
              <img v-else-if="facility == 'รับจองล่วงหน้า'" src="/icons/รับจองล่วงหน้า.png" :title="facility" />
              <img
                v-else-if="facility == 'สามารถนำสัตว์เลี้ยงเข้าได้'"
                src="/icons/สามารถนำสัตว์เลี้ยงเข้าได้.png"
                :title="facility"
              />
            </div>
          </div>
